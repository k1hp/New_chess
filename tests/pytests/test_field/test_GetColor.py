...
def test_set_back(horizontal, vertical, back_color, result):
...
def test_set_back_fail(horizontal, vertical, back_color, result):
...
def test_set_figure(horizontal, vertical, figure_color, result):
    color = GetColor(horizontal, vertical)
...
def test_set_figure_fail(horizontal, vertical, figure_color, result):
